...
Java solution for https://www.codingame.com/training/hard/obsolete-programming[codingame puzzle obsolete programming]

Test cases implemented as Unit Tests.

:toc:

== Description from codingame
...
any number of lines: whatever the obsolete program outputs
Constraints
1 ≤ N ≤ 100
...
As an extension, additional instructions have been implemented.

* `IN` reads an integer from input

With this change its possible to write program that take input, and, for example solve https://www.codingame.com/multiplayer/codegolf/temperature-code-golf/leaderboard[Temperatures code golf]

See the link:src/test/resources/temperatures-golf.txt[solution here]