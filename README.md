...
Basically the language is based on `RPN` (Reverse Polish Notation) with the ability to define new instructions.
...
Note that name can appear in its own definition (recursion is available).
